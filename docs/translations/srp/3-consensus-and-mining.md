...
- **Рокови савијени временом:** Трансформација дистрибуције (експоненцијална→хи-квадрат) смањује дуге блокове, побољшава просечна времена блокова
...
- Циљано време блока: 120 секунди (mainnet), 1 секунда (regtest)
...
**Сврха:** Трансформише експоненцијалну у хи-квадрат дистрибуцију. Веома добра решења се кују касније (мрежа има времена да скенира дискове), лоша решења су побољшана. Смањује дуге блокове, одржава просек од 120s.
...
- Активирано након периода кашњења (подразумевано: 4 блока)
