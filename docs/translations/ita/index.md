...
**🚀 Mainnet Attiva**: La mainnet è attiva dal 3 maggio 2026.
...
Bitcoin-PoCX eredita la licenza MIT di Bitcoin Core. Vedere `bitcoin/COPYING` nella directory principale del repository.
