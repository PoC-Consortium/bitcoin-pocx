...
**Toteutus:** `src/pocx/assignments/opcodes.cpp`
...
**Toteutus:** `src/validation.cpp:ConnectBlock()`
...
**Toteutus:** `src/pocx/assignments/opcodes.cpp:VerifyPlotOwnership()`
...
**Toteutus:** `src/consensus/tx_check.cpp`
...
**Toteutus:** `src/validation.cpp:PreChecks()`
...
**Toteutus:** `src/txdb.cpp:BatchWriteAssignments()`
...
**Toteutus:** `src/validation.cpp:DisconnectBlock()`
...
private:
    ...
    mutable ForgingAssignmentsMap deletedAssignments;  // Track deletions (map, not set)  // Seuraa poistoja
...
**Toteutus:** `src/pocx/rpc/assignments.cpp`
...
**Toteutus:** `src/pocx/rpc/assignments_wallet.cpp`
...
**Toteutus:** `src/pocx/assignments/transactions.cpp`
...
```
src/
├── coins.h                        # ForgingAssignment-rakenne, CCoinsViewCache-metodit
├── coins.cpp                      # Välimuistin hallinta, eräkirjoitukset
│
├── txdb.h                         # CCoinsViewDB-delegointimetodit
├── txdb.cpp                       # Tietokannan luku/kirjoitus
│
