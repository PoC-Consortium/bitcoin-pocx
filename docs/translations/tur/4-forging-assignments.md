...
**Uygulama:** `src/pocx/assignments/opcodes.cpp`
...
**Uygulama:** `src/validation.cpp:ConnectBlock()`
...
**Uygulama:** `src/pocx/assignments/opcodes.cpp:VerifyPlotOwnership()`
...
**Uygulama:** `src/consensus/tx_check.cpp`
...
**Uygulama:** `src/validation.cpp:PreChecks()`
...
**Uygulama:** `src/txdb.cpp:BatchWriteAssignments()`
...
**Uygulama:** `src/validation.cpp:DisconnectBlock()`
...
private:
    ...
    mutable ForgingAssignmentsMap deletedAssignments;  // Track deletions (map, not set)  // Silmeleri izle
...
**Uygulama:** `src/pocx/rpc/assignments.cpp`
...
**Uygulama:** `src/pocx/rpc/assignments_wallet.cpp`
...
**Uygulama:** `src/pocx/assignments/transactions.cpp`
...
```
src/
├── coins.h                        # ForgingAssignment yapısı, CCoinsViewCache yöntemleri
├── coins.cpp                      # Önbellek yönetimi, toplu yazımlar
│
├── txdb.h                         # CCoinsViewDB atama yöntemleri
├── txdb.cpp                       # Veritabanı okuma/yazma
│
