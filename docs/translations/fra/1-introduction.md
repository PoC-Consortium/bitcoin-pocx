...
**Solution** : Transformation de distribution de l'exponentielle vers Weibull (forme k=3) en utilisant la racine cubique : `Y = échelle × (X^(1/3))`.
...
- **Temps de bloc** : 120 secondes (tous les réseaux : mainnet, testnet, regtest)
