...
(2) Алгоритм Time-Bending, що трансформує розподіл дедлайнів з експоненційного в розподіл Вейбулла (форма k=3), зменшуючи дисперсію часу блоків без зміни середнього;
...
| Період | Роки | Халвінги | Мін. масштабування | Робота плоту (відносно базового POC2) |
|--------|------|----------|-------------------|----------------------|
...
Стовпець множника виражений відносно нехардненого базового формату **POC2**. Оскільки хардований формат X1 вже вбудовує 2× роботи POC2, рівень Xn дорівнює 2ⁿ × POC2 — еквівалентно 2^(n-1) × X1, що відповідає визначенню на рівень у Розділі 3.5.
...
| Початкова субсидія | 10 BTCX |
| Інтервал халвінгу | 1050000 блоків (~4 роки) |
| Загальна пропозиція | ~21 мільйон BTCX |
...
| Режим низької ємності | Увімкнено (~16 MiB плоти, 64 nonces) |
...
Система працює в основній мережі з 3 травня 2026. Потужність майнінгу походить з ємності сховища, а не хешрейту, зменшуючи енергоспоживання на порядки величини при підтримці доведеної економічної моделі Bitcoin.
