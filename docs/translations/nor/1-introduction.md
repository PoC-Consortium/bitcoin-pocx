...
```
bitcoin-pocx/
├── bitcoin/             # Bitcoin Core v30.2 + PoCX-integrasjon
...
- **Minne**: 4-8 GB RAM
- **Lagring**: Ny kjede, for øyeblikket tom (kan vokse ~5× raskere enn Bitcoin på grunn av 2-minutters blokker og tildelingsdatabase)
