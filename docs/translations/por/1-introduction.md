...
**Solução**: Transformação de distribuição de exponencial para Weibull (parâmetro de forma k=3) usando raiz cúbica: `Y = escala × (X^(1/3))`.
...
- **Tempo de Bloco**: 120 segundos (todas as redes: mainnet, testnet, regtest)
