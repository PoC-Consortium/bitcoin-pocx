...
**Implementering:** `src/pocx/assignments/opcodes.cpp`
...
**Implementering:** `src/validation.cpp:ConnectBlock()`
...
**Implementering:** `src/pocx/assignments/opcodes.cpp:VerifyPlotOwnership()`
...
**Implementering:** `src/consensus/tx_check.cpp`
...
**Implementering:** `src/validation.cpp:PreChecks()`
...
**Implementering:** `src/coins.cpp:Flush()`
...
**Implementering:** `src/txdb.cpp:BatchWriteAssignments()`
...
**Implementering:** `src/validation.cpp:DisconnectBlock()`
...
private:
    ...
    mutable ForgingAssignmentsMap deletedAssignments;  // Track deletions (map, not set)  // Spor sletninger
...
**Implementering:** `src/pocx/rpc/assignments.cpp`
...
**Implementering:** `src/pocx/rpc/assignments_wallet.cpp`
...
**Implementering:** `src/pocx/assignments/transactions.cpp`
...
-- coins.cpp                      # Cache-styring, batch-skrivninger
|
-- txdb.h                         # CCoinsViewDB assignment-metoder
-- txdb.cpp                       # Database laes/skriv
|
